...
func TestParseEnsAPIAddress(t *testing.T) {
	for _, x := range []struct {
	...
	}{
		{
			...
			value:       "/data/testnet/glyff.ipc",
			endpoint:    "/data/testnet/glyff.ipc",
		},
		{
		...
		},
		{
			...
			value:       "test:/data/testnet/glyff.ipc",
			endpoint:    "/data/testnet/glyff.ipc",
			tld:         "test",
		},
		{
		...
		},
		{
			...
			value:       "314159265dD8dbb310642f98f50C066173C1259b@/data/testnet/glyff.ipc",
			endpoint:    "/data/testnet/glyff.ipc",
		...
		},
		{
			...
			value:       "test:314159265dD8dbb310642f98f50C066173C1259b@/data/testnet/glyff.ipc",
			endpoint:    "/data/testnet/glyff.ipc",
			addr:        common.HexToAddress("314159265dD8dbb310642f98f50C066173C1259b"),
			tld:         "test",
		},
