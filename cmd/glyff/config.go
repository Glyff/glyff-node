...
func loadConfig(file string, cfg *glyffConfig) error {
	f, err := os.Open(file)
	if err != nil {
		return err
	}
...
func defaultNodeConfig() node.Config {
	...
	cfg.IPCPath = "glyff.ipc"
	return cfg
}

func makeConfigNode(ctx *cli.Context) (*node.Node, glyffConfig) {
	// Load defaults.
	cfg := glyffConfig{
