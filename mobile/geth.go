...
// NodeConfig represents the collection of configuration values to fine tune the Glyff
...
// Node represents a Glyff Ethereum node instance.
type Node struct {
	node *node.Node
}

// NewNode creates and configures a new Glyff node.
