...
import (
	...
	"github.com/glyff/glyff-node/internal/jsre"
	"github.com/glyff/glyff-node/internal/web3ext"
...
// Welcome show summary of current Glyff instance and some metadata about the
// console's available modules.
func (c *Console) Welcome() {
	// Print some generic Glyff metadata
	fmt.Fprintf(c.printer, "Welcome to the Glyff JavaScript console!\n\n")
	c.jsre.Run(`
