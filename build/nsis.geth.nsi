...
# 1. install glyff for all users
# 2. install optional development tools such as abigen
# 3. create an uninstaller
# 4. configures the Windows firewall for glyff
# 5. create glyff, attach and uninstall start menu entries
...
function .onInit
  # make vars are global for all users since glyff is installed global
